...
const Form = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_4imbvri",   // Replace with EmailJS Service ID
        "template_uqk0e92",  // Replace with EmailJS Template ID
        formRef.current,
        "H90YS_fCBw0-bgcHO"    // Replace with EmailJS Public Key
      )
      .then(
        () => {
  ...
  return (
    <div>
      ...
      <div className="mx-2">
        <form ref={formRef} onSubmit={sendEmail} className="flex flex-col gap-4 mt-4">
